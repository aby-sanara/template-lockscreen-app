            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="nama" class="form-control" id="nama" placeholder="nama aplikasi anda">
                    </div>
                    <div class="form-group mb-3">
                        <label for="tag" class="form-label">Tag Line</label>
                        <input type="text" name="tag" class="form-control" id="tag" placeholder="masukkan tag line anda">
                    </div>
                    <div class="form-group mb-3">
                        <label for="sesi" class="form-label">Lock Screen (dalam detik)</label>
                        <input type="text" name="sesi" pattern="[0-9]+" title="hanya angka" class="form-control" id="sesi" placeholder="waktu lock screen dalam detik" required>
